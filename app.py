...
def create_app():
    ...
    def home():
        ...
        try:
            ...
            target_prompt_type = PromptType.GENERATE_IMAGE_HAPPY if is_above_100k else PromptType.GENERATE_IMAGE_SAD
            ...
            if is_above_100k:
                ...
                message = f"😅 Bitcoin is at ${btc_price:,.2f} - Still waiting for $100K..."
...
def demo_mode():
    ...
    if is_above_100k:
        message = "🚀 Bitcoin is above $100K! Time to celebrate! 🎉"
        try:
            image_url = url_for('static', filename='images/happy_investor_btc100k_lol.png')
        except:
            image_url = DEFAULT_IMAGE_URL
    else:
        message = f"😅 Bitcoin is at ${demo_price:,.2f} - Still waiting for $100K..."
        try:
            image_url = url_for('static', filename='images/sad_investor_btc100k_lol.png')
        except:
            image_url = DEFAULT_IMAGE_URL
...
def get_current_image(prompt_type: PromptType) -> str:
    ...
    try:
        ...
        latest_version = db_accessor.query(DailyImageVersion).filter(
